...
public class PGKatAdapter extends RecyclerView.Adapter {
...
// before loading more.
    ...
    private OnLoadMoreKP onLoadMoreListener;

    public PGKatAdapter(List<KPGModel> modeldata, RecyclerView recyclerView) {
                            ...
                            if (!loading
                                ...
                                if (modeldataList.size() <= 10) {
                                    ...
                                    if (onLoadMoreListener != null) {
                                        onLoadMoreListener.onLoadMoreKP();
                                    }
                                    loading = true;
                                }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent,
        ...
        if (viewType == VIEW_ITEM) {
            View v = LayoutInflater.from(parent.getContext()).inflate(
                    R.layout.list_ktpengeluaran, parent, false);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof StudentViewHolder) {
            KPGModel singleStudent= (KPGModel) modeldataList.get(position);
    ...
    public void setOnLoadMoreListener(OnLoadMoreKP onLoadMoreListener) {
    ...
    public static class StudentViewHolder extends RecyclerView.ViewHolder {
        ...
        public StudentViewHolder(View v) {
            ...
            namakategori = (TextView) v.findViewById(R.id.nama_kategori_ktpg);
            keterangankategori = (TextView) v.findViewById(R.id.txtketerangan_ktpg);
            jeniskategori1 = (TextView) v.findViewById(R.id.jenis_kategori_ktpg);
            idjenis = (TextView) v.findViewById(R.id.id_jenis_tr_ktpg);
            imgProfile = (ImageView) v.findViewById(R.id.icon_profile_ktpg);

            LinearLayout navButton4 = (LinearLayout) v.findViewById(R.id.message_container_ktpg);
            navButton4.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    //Intent intent = new Intent(contextx, KategoriActivity.class);
