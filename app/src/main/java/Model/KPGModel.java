...
public class KPGModel {
    ...
    public KPGModel(String id_jenis_transaksi, String nm_jenis_transaksi, String jenis_transaksi, String keterangan, String id_group_transaksi, String status_default) {
